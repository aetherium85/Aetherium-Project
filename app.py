...
st.markdown(
    ...
    /* This targets the specific container generated by st.container(border=True) */
    div[data-testid="stVerticalBlockBorderWrapper"] {
        background-color: rgba(0, 0, 0, 0.6) !important; /* Dark Glass Background */
        backdrop-filter: blur(10px);
        border: 1px solid rgba(255, 255, 255, 0.2) !important;
        border-radius: 10px !important;
    }
    
    /* FORCE TEXT VISIBILITY inside the box */
    div[data-testid="stVerticalBlockBorderWrapper"] div,
    div[data-testid="stVerticalBlockBorderWrapper"] p,
    div[data-testid="stVerticalBlockBorderWrapper"] li,
    div[data-testid="stVerticalBlockBorderWrapper"] span {
        color: #FFFFFF !important;
        background-color: transparent !important; /* Removes default white backgrounds */
    }
    ...
    /* 4. BUTTON FIX (CRITICAL) */
    /* This forces the buttons inside the box to have a dark background so white text is visible */
    div[data-testid="stVerticalBlockBorderWrapper"] button {
        background-color: rgba(255, 255, 255, 0.15) !important; /* Visible button background */
    ...
    div[data-testid="stVerticalBlockBorderWrapper"] button:hover {
        background-color: #70C4B0 !important; /* Teal on hover */
